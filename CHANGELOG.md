...
### Fixed
- **[Hotfix]** Fix missing type `HumanoidPrefabInfo` in AvatarRegistrationWindow.cs
  - Changed to use `PrefabInfo` from PackageAnalyzer
...
### Fixed
- **[Hotfix]** Change default server URL from HTTP to HTTPS (port 8443)
  - Unity 2022+ blocks HTTP connections by default ("Insecure connection not allowed" error)
  - Avatar list and bug report APIs now work correctly on Unity 2022+
...
### Fixed
- Add missing .meta files for Editor, Runtime, and package.json
